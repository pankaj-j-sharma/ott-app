                    ...
                    <div class="col-md-6">
                      <div class="fileupload_block">
                        ...
                        <div class="fileupload_img">
                            <img src="images/Upload.png" alt="edit video image" height="20px" width="90px" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">                    
                      ...
                      <!--<script>CKEDITOR.replace( 'video_description' );</script>-->
                        ...
                        <button type="submit" name="submit" id="submit" class="btn btn-primary btn-round">Save</button>
                </div>
              </div>
            </form>
          </div>
