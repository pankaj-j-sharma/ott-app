...
define('DB_DATABASE',"ott"); // database name
define('DB_SERVER',"localhost"); // db server
*/
/*   */
# for server 
#define('DB_USER',"pankaj"); // db user
#define('DB_PASSWORD',"qbolbk"); // db password (mention your db password here)
...
define('DB_DATABASE',"ottapidb"); // database name
define('DB_SERVER',"localhost"); // db server
/*   */
