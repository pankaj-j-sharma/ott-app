<?php include("includes/connection.php");
      ...
      $liveClassPages = array("manage_live_classes.php");
?>
<!DOCTYPE html>
<html>
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
          ...
          <li <?php if(in_array($currentFile,$liveClassPages)){?>class="nav-item active"<?php }?>>
            <a class="nav-link" href="manage_live_classes.php">
             <i class="nc-icon nc-button-play"></i>
              <b>Live Classes</b>
            </a>
          </li>          
          ...
          <li <?php if($currentFile=="add_apk.php"){?>class="nav-item active"<?php }?>>
            <a class="nav-link" href="add_apk.php">
              <i class="nc-icon nc-app"></i>
              <b>Upload APK</b>
            </a>
          </li>		  
