...
import com.incampusit.ottstreaming.PlayerActivity;
...
//        holder.text.setText(filename[position]);
        ...
        Glide.with(mContext).load(Uri.fromFile(new File(filepath[position]))).placeholder(R.mipmap.ic_launcher_foreground).centerCrop().crossFade().diskCacheStrategy(DiskCacheStrategy.RESULT).into(holder.image);
